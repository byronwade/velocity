...
export type Mode = 'agents' | 'editor' | 'terminal' | 'browser' | 'builder' | 'database' | 'observe' | 'design' | 'test' | 'ship' | 'home';

export const MODES: Mode[] = ['agents', 'editor', 'terminal', 'browser', 'builder', 'database', 'observe', 'design', 'test', 'ship', 'home'];
