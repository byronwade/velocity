...
export type Mode = 'agents' | 'editor' | 'terminal' | 'browser' | 'builder' | 'database' | 'observe' | 'design' | 'test' | 'ship' | 'home' | 'mission';

export const MODES: Mode[] = ['agents', 'editor', 'terminal', 'browser', 'builder', 'database', 'observe', 'design', 'test', 'ship', 'home', 'mission'];

/** The modes an "app" tab can be — the agent is the persistent brain, not an app. */
export const APP_MODES: Mode[] = ['editor', 'terminal', 'browser', 'builder', 'database', 'observe', 'design', 'test', 'ship'];
